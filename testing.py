...
fix_living_cost = dp.exact_living_cost()
print(f"Living Cost (Monthly): {fix_living_cost}%")

avg_percentage = dp.us_avg_percentage_growth()
print(f"Kenaikan Tuition (Yearly): {avg_percentage}%")

hasil_kurs = dp.exchange_rate_growth()
print(f"Kenaikan Kurs USD/IDR (Yearly): {hasil_kurs}%")